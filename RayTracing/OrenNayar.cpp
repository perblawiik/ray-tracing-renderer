...
OrenNayar::OrenNayar(const SurfaceType& type, const glm::dvec3 color, const double& reflection_coeff, const double& roughness)
	: Material(type, color, reflection_coeff), roughness(roughness)
{}

OrenNayar::OrenNayar(const OrenNayar& l)
	: OrenNayar(l.surface_type, l.color, l.reflection_coefficient, l.roughness)
{}
